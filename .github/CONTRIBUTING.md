# Contributing to AWS Signature Version 4 API by Codebelt
...
- The solution is `Codebelt.AwsSignature4.slnx`. Central package versions are maintained in `Directory.Packages.props`.
...
- `Codebelt.AwsSignature4.slnx` is the solution used for local development.
...
```powershell
dotnet restore "Codebelt.AwsSignature4.slnx"
dotnet build "Codebelt.AwsSignature4.slnx" --configuration Release --no-restore
```
...
```powershell
dotnet pack "Codebelt.AwsSignature4.slnx" --configuration Release --no-restore
```
...
By contributing to AWS Signature Version 4 API by Codebelt, you agree that your contributions will be licensed under the MIT license.
